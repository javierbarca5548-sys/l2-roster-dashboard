...
export default function App(){
  ...
  return (
    <div className="mx-auto max-w-[1400px] space-y-5 p-4">
      ...
      {tab === 'Roster' && (
        <>
          ...
          <section className="grid grid-cols-2 gap-3 md:grid-cols-4">
            ...
            <div className="flex items-center gap-2 rounded-2xl border bg-white p-4 shadow-sm"><div className="text-sm text-slate-500">Autosave</div><Toggle checked={true} onChange={()=>{}}/></div>
          </section>
          ...
          <DataTable rows={filtered} setRows={setMembers} visibleCols={visibleCols} />
          <Charts members={filtered} raidWindows={raidWindows} />
          <Heatmap grid={grid} />
        </>
      )}
      ...
      <footer className="py-6 text-center text-xs text-slate-400">Built for Lineage 2 planning • Save/Share/Export • Raid windows linked to availability • Colorful labeled charts • Dropdown editing</footer>
    </div>
  );
}
